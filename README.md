# AI-Compliant-Routing-System-using-Machine-Learning-
The system uses open-source tools like SentenceTransformers, FAISS, scikit-learn, and OpenAI Whisper running locally without external APIs.
